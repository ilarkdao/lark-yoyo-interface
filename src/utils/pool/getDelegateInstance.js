import delegate from '../../../public/YoyoStakingPool.json'

const getDelegateInstance = async function(){
  let instance = new this.web3.eth.Contract(delegate.abi, this.yoyoStakingPool)
  // console.log(289, 'YoyoStaking',instance, this.yoyoStakingPool)

  //将得到的数据存入vuex中
  this.$store.commit('saveDelegateInstance', instance)

  let instance2 = new this.web4.eth.Contract(delegate.abi, this.yoyoStakingPool)
